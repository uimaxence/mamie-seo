...
export default function EditorialSection({ title, dimension, index }: EditorialSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Point fort */}
      <div className="mb-3">
        <span className="text-[10px] font-medium uppercase tracking-[0.07em] text-[#2D8A5E] block mb-1">
          Point fort
        </span>
      ...
      <div className="mb-3">
        <span className="text-[10px] font-medium uppercase tracking-[0.07em] text-[#E05A2B] block mb-1">
          À améliorer
        </span>
        <p className="text-[15px] text-[#525252] leading-relaxed">
