  ...
  return (
    <div className="bg-white border border-[#e5e5e5] rounded-[12px] p-5">
      <div className="flex items-start justify-between mb-4">
        <h3 className="text-[11px] font-medium uppercase tracking-[0.07em] text-[#525252]">
          Mots-clés métier
        </h3>
      ...
      {/* Detected keywords */}
      <div className="mb-4">
        <span className="text-[11px] font-medium uppercase tracking-[0.07em] text-[#2D8A5E] block mb-2">
          Mots-clés détectés
        </span>
      ...
      {/* Missing keywords */}
      <div className="mb-4">
        <span className="text-[11px] font-medium uppercase tracking-[0.07em] text-[#E05A2B] block mb-2">
